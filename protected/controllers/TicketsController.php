...
class TicketsController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Tickets']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->ticket_number));
		}
    ...
    public function actionExcel()
    {
        ...
        $output = $csv->toCSV();
        Yii::app()->getRequest()->sendFile("fullTicketsReport.csv", $output, true);
...
//        $result = implode("-",$krr);
        ...
        Yii::import('ext.ECSVExport');
        $dataProvider=new CActiveDataProvider('Tickets' ,array('criteria'=>array( 'condition'=>'LEFT(ticket_date,10)="'.$date.'"')));

        $csv = new ECSVExport($dataProvider);
        $output = $csv->toCSV();
        Yii::app()->getRequest()->sendFile("dailyTicketsReport.csv", $output, true);
