...
class UnacceptedLoansCallsController extends Controller
{
	/**
	 ...
	 * @return UnacceptedLoansCalls the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=UnacceptedLoansCalls::model()->findByPk($id);
		if($model===null)
...
//        $result = implode("-",$krr);
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='unaccepted-loans-calls-form')
		{
