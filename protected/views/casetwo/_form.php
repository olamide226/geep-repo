...
-->
    ...
    <div class="row">
        ...
        <?php echo $form->dropDownList($model,'complaints', array(
                ...
                "Lives in a rural area, no bank and no internet."=>"Lives in rural area, no bank and no internet.",
                ...
                "Customer is unable to input account numbers beginning with zero."=>"Customer is unable to input account numbers beginning with zero.",
                ...
                "Customer complained of not getting a response after submitting the form."=>"Customer complained of not getting a response after submitting form.",
                ...
                "Customer wants to know the gain to the association if they register their members."=>"Customer want to know the gain to the association if they register their members.",
                ...
                "Customer wants to know maximum and minimum number of members that can apply."=>"Customer want to know maximum and minimum number of members that can apply.",
