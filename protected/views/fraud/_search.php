...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'agent_phn_number',array('size'=>12,'maxlength'=>12)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'payment_medium'); ?>
		<?php echo $form->textField($model,'payment_medium',array('size'=>60,'maxlength'=>100)); ?>
	</div>
